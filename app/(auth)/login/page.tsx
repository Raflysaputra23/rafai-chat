...
const Login = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center gap-6 overflow-x-hidden'>
            <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className='w-[95%] max-w-100 shadow-[2px_2px_10px_rgba(0,0,0,0.2)] p-6 rounded-xl bg-card border border-border glow-primary relative'>
                ...
                <p className='text-sm text-muted-foreground text-center mb-8'>Masuk ke akun anda untuk melanjutkan</p>
                <form className='w-full space-y-5'>
                    ...
                    <Button variant={"hero"} className='text-foreground w-full'>Masuk</Button>
                </form>
            ...
            <motion.p
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className='text-muted-foreground'>Sudah punya akun? <Link href="/register" className="text-primary hover:underline">Daftar</Link></motion.p>
        </div>
    )
}
