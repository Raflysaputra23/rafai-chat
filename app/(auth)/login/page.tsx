    ...
    return (
        <div className='w-full h-full flex justify-center items-center overflow-hidden'>
            <motion.div
                ...
                className='flex flex-col justify-center items-center gap-5 w-[98%] max-w-112.5'>
                <div className='shadow-[2px_2px_10px_rgba(0,0,0,0.2)] p-6 rounded-xl bg-card border border-border glow-primary relative'>
                    ...
                    {message && <div className={`flex items-center justify-center ${state?.success ? 'bg-green-500/10 border-green-500/30' : 'bg-red-500/10 border-red-500/30'} p-4 rounded-md border mb-4`}>
                        <p className={`text-xs ${state?.success ? 'text-green-500/50' : 'text-red-500/50'}`}>{message}</p>
                    </div>}
