...
const Register = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center gap-4 overflow-x-hidden'>
            <motion.div
                ...
                <p className='text-sm text-muted-foreground text-center mb-8'>Bergabung dengan kami untuk melanjutkan</p>
            ...
            <p
                className='text-muted-foreground'>Belum punya akun? <Link href="/login" className="text-primary hover:underline">Masuk</Link></p>
        </div>
    )
}
